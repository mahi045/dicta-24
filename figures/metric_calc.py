...
if __name__ == '__main__':
    ...
    for filename in os.listdir(os.path.join(FOLDER_ROOT, ORIGINAL_FOLDER)):
        ...
        data_list = [filename, original_contrast, he_contrast, he_psnr]
        ...
        print(data_list[0], " & ".join(["{0:.3f}".format(data) for data in [data_list[1], data_list[2],data_list[4],data_list[6], data_list[3],data_list[5],data_list[7]]]))
